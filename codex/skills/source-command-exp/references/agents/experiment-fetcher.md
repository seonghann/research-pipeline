...
Called via: `Delegation brief("Experiments: <query about runs, metrics, or comparisons>")`
...
1. **Parse the query** — identify:
   - Which project/entity (from project AGENTS.md or .mcp.json)
...
- Read (project AGENTS.md, .mcp.json for entity/project info)
