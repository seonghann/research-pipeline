---
name: source-command-prereport
description: "Synthesize research context into a pre-report before implementation."
---
...
This command should come AFTER the discuss phase — the user and Codex have
