...
description: "Investigate a research question with permanent, runnable analysis scripts and evidence."
---
...
**Example:**
```
Delegation brief("Analyze: softmax output이 0이 되는 케이스 있는지.
