...
Delegation brief("Implement: <progress log path or task description>")
...
2. Read project AGENTS.md for coding standards and conventions
...
- Native subagent tools (delegate to analyzer if investigation needed)
